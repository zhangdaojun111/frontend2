...
export const dgcService = {
    ...
    //替换的图标
    replacingIcons: {
        checkboxChecked: '<i class="checkbox-check"></i>',
        checkboxUnchecked: '<i class="checkbox-uncheck"></i>',
        checkboxIndeterminate: '<i class="checkbox-uncheck"></i>',
        columnMovePivot: '<i class="checkbox-uncheck"></i>',
        columnMoveGroup: '<i class="checkbox-uncheck"></i>',
        columnMovePin: '<i class="checkbox-uncheck"></i>',
        columnMoveAdd: '<i class="checkbox-uncheck"></i>',
        columnMoveHide: '<i class="checkbox-uncheck"></i>',
        columnMoveMove: '<i class="checkbox-uncheck"></i>',
        columnMoveLeft: '<i class="checkbox-uncheck"></i>',
        columnMoveRight: '<i class="checkbox-uncheck"></i>',
        columnMoveValue: '<i class="checkbox-uncheck"></i>',
        dropNotAllowed: '<i class="checkbox-uncheck"></i>',
        rowGroupPanel: '<i class="checkbox-uncheck"></i>',
        pivotPanel: '<i class="checkbox-uncheck"></i>',
        valuePanel: '<i class="checkbox-uncheck"></i>',
        sortAscending: '<i class="sort-1"></i>',
        sortDescending: '<i class="sort-2"></i>',
        groupExpanded: '<i class="group-expand"></i>',
        groupContracted: '<i class="group-close"></i>',
    },
    //返回fieds
