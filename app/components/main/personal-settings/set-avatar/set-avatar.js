...
let config = {
    ...
    actions:{
        ...
        //     //请求数据
        //     if(data.success === 1){
        //         this.data.picSrc = data.picSrc;
        //         this.data.JPosition.Jx = data.left;
        //         this.data.JPosition.Jy = data.top;
        //         this.data.JPosition.length = data.length;
        //         this.actions.setImageProportion(this.data.picSrc);
        //     }else{
        //         //数据获取失败或用户没有默认头像
        //         this.data.JPosition.Jx = 0;
        //         this.data.JPosition.Jy = 0;
        //         this.data.JPosition.length = 0;
        //     }
        // }
    },
    binds:[
