...
.department-group,.position-group {
    width: 210px;
    height: 50px;
    float: left;
    margin-left: 70px;
...
let userInfoDisplay = {
    ...
    actions:{
        ...
        initInfo:function () {
            ...
            if(src !== ''){
                let $img = $("<img>").addClass("user-avatar").attr('src', src);
