...
let config = {
    ...
    data: {
        ...
        columnDefsDepartment:[
            {headerName: '用户', width: 120,maxWidth:270,field:'user',tooltipField:'user',cellRenderer: 'group',cellStyle: {'text-align': 'left','margin-left':'10px'}, suppressSorting: false,suppressMenu: true,minWidth: 50},
