...
let config={
    template:`<div style="position: relative;">
                ...
                {{else}}
                <input class="search-value show-hide-drop width100 dynamic-form-input" type="text" readonly data-value="{{value}}" value="{{showValue}}" style="width: {{width}}; margin-right: 5px"/>
                {{/if}}
