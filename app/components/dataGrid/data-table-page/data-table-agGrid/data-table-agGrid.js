        ...
        setHeaderData: function (res) {
            ...
            for (let i = 0; i < temp.length; i++) {
                if (typeof (temp[i]) == 'object') {
                    temp[i]['addressss'] = JSON.stringify({
                        feAddress: temp[i]['feAddress'],
                        beAddress: temp[i]['beAddress']
                    })
                }
            }
...
>>>>>>> cb8ff0b8ecd57010bf57b7a8195c36d53b5f86de
...
>>>>>>> cb8ff0b8ecd57010bf57b7a8195c36d53b5f86de
        ...
        onRowDoubleClicked: function (data) {
            ...
            if (this.data.viewMode == 'in_process' || data["data"]["status"] == 2 || this.data.permission.edit == 0 || this.data.parent_btnType == 'none') {
                obj.btnType = 'none';
            }
            let url = dgcService.returnIframeUrl('/iframe/addWf/', obj);
            let title = '查看';
